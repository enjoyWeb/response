...
var loadingProcess = {
    ...
    init: function() {
        ...
        document.getElementById("flashCff").innerHTML = '<object id=picMe name=picMe codeBase=http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0 height="1" width="1" classid=clsid:D27CDB6E-AE6D-11cf-96B8-444553540000><PARAM NAME="_cx" VALUE="5080"><PARAM NAME="_cy" VALUE="5080"><PARAM NAME="FlashVars" VALUE=""><PARAM NAME="Movie" VALUE="images/hdpic/images/loadingAs3.swf"><PARAM NAME="Src" VALUE="images/hdpic/images/loadingAs3.swf"><PARAM NAME="WMode" VALUE="Transparent"><PARAM NAME="Play" VALUE="-1"><PARAM NAME="Loop" VALUE="-1"><PARAM NAME="Quality" VALUE="High"><PARAM NAME="SAlign" VALUE=""><PARAM NAME="Menu" VALUE="-1"><PARAM NAME="Base" VALUE=""><PARAM NAME="AllowScriptAccess" VALUE="always"><PARAM NAME="Scale" VALUE="NoBorder"><PARAM NAME="DeviceFont" VALUE="0"><PARAM NAME="EmbedMovie" VALUE="0"><PARAM NAME="BGColor" VALUE=""><PARAM NAME="SWRemote" VALUE=""><PARAM NAME="MovieData" VALUE=""><PARAM NAME="SeamlessTabbing" VALUE="1"><PARAM NAME="Profile" VALUE="0"><PARAM NAME="ProfileAddress" VALUE=""><PARAM NAME="ProfilePort" VALUE="0"><PARAM NAME="AllowNetworking" VALUE="all"><PARAM NAME="AllowFullScreen" VALUE="true"><embed type="application/x-shockwave-flash" src="images/hdpic/images/loadingAs3.swf" id="picMeFF" name="picMeFF" wmode="window" quality="high" allownetworking="all" allowscriptaccess="always" allowfullscreen="true" scale="noborder" pluginspage="http://www.macromedia.com/go/getflashplayer" width="1" height="1"></embed></object>'
    },
    ...
    ioErrorPicHandler: function() {
        ...
        picShow.showPic("images/ajax-loadernone.gif");
    },
...
picShow = {
	...
	changeHeight:function(){
		if(Jq(".article_l_warp").height() > Jq(".c_r_warp").height()){
			Jq(".c_r_bottom").css("height",Jq(".article_l_warp").height()-Jq(".c_r_warp").height()-2);
			Jq(".c_l_bottom").css("display","none");
		}else{
			Jq(".c_l_bottom").css("height",Jq(".c_r_warp").height()-Jq(".article_l_warp").height());
    ...
    showTips: function(a) {
        if (Cookieget("oPENtIPS") == "show" || Cookieget("oPENtIPS") == null) {
            ...
            this.$("titleArea").style.visibility = "visible"
        } else {
            ...
            this.$("titleArea").style.visibility = "hidden"
        }
        ...
        if (photoJson[a].showtxt) {
            ...
            this.$("contTxt").style.display = "none";
		}
    },
    ...
    Loader: function() {
        ...
        picShow.$("Display").style.filter = "alpha(opacity:1)";
        ...
        function() {
            ...
            picShow.$("titleArea").style.display = "none";
            picShow.$("buttonArea").style.display = "none";
            picShow.$("picTips").style.visibility = "hidden";
            picShow.$("titleArea").style.visibility = "hidden";
        ...
        function() {
            ...
            picShow.$("titleArea").style.visibility = "visible";
        ...
        function() {
            ...
            function(e) {
                ...
                if (prev) {
                    picShow.$("mainArea").style.cursor = "url(" + "http://mat1.gtimg.com/news/2009hd/arr_left.cur" + "),auto";
                    picShow.$("Display").style.cursor = "url(" + "http://mat1.gtimg.com/news/2009hd/arr_left.cur" + "),auto";
                    picShow.$("mainArea").title = "上一张";
                    picShow.$("Display").title = "上一张";
                } else {
                    picShow.$("mainArea").style.cursor = "url(" + "http://mat1.gtimg.com/news/2009hd/arr_right.cur" + "),auto";
                    picShow.$("Display").style.cursor = "url(" + "http://mat1.gtimg.com/news/2009hd/arr_right.cur" + "),auto";
    ...
    viewPrev: function() {
        ...
        if (this.Now > 0) {
            this.Now--;
            window.location.href = window.location.href.replace( /#.*/, '' ) + "#p=" + (this.Now + 1);
            this.showSmallImageReload("smallPhoto");
    ...
    showSmallImageReload: function(a) {
        ...
        for (var d = Number(this.Count), f = new Image, e = 0; e < d; e++) {
            ...
            c.innerHTML = f.width > f.height ? "<div onclick='picShow.viewJump(" + e + ")'><span class='imgs'><img src='" + photoJson[e].smallpic + "' width='78' alt='点击浏览第" + (e + 1) + "张图片'/></span><span class='titles'>" + (e + 1) + "<em>&nbsp;/ " + d + "</em></span></div>": "<div onclick='picShow.viewJump(" + e + ")'><span class='imgs'><img src='" + photoJson[e].smallpic + "' alt='点击浏览第" + (e + 1) + "张图片' /></span><span class='titles'>" + (e + 1) + "<em>&nbsp;/ " + d + "</em></span></div>";
...
function addCount(a) {
    if (typeof pgvMain == "function"){
		if(pvRefUrl!=="-" && pvRefDomain!=="-"){//第一次不上报
			pvRepeatCount = 1;
			pgvMain();
		}
